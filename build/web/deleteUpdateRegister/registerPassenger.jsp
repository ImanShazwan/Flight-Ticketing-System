<%-- 
    Document   : registerPassenger
    Created on : Mar 23, 2024, 9:40:59 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <%-- <%
            ...
            rs.next();
        %> --%>
        <form action="/FlightTicketingSystem/insertuser" method="post" >
            <div class="form-group row">
                <label for="passengerID" class="col-4 col-form-label">Passenger ID</label> 
                <div class="col-8">
                    <input id="passengerName" name="passengerID" placeholder="Insert ID" type="text" 
